<?php
	...
	{
		echo"U bent niet ingelogt en daarom niet bevoegd om deze pagina te bekijken";
		header("refresh:4;url=index.php?content=homepage");
		exit();
	}
	else if ( !in_array($_SESSION['userrole'], 
	$userrole))
	{
		echo "U bent wel ingelogd, maar niet bevoegd deze pagina te bekijken.
